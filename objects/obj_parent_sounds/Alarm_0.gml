if (drag == 1)
{
    if ((place_meeting(obj_creation_preview.x, obj_creation_preview.y, obj_parent_sounds) && (!(place_meeting(obj_creation_preview.x, obj_creation_preview.y, id)))) || place_meeting(x, y, obj_arrow_lock))
        drop_lock = 1
    else
        drop_lock = 0
    depth = -19
