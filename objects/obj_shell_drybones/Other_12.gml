...
else if (keyboard_check(global.arriba) && global.style == 2)
{
    ...
    if (global.theme == "underwater" || (global.night == 1 && global.theme == "airship") || (global.night == 1 && global.theme == "sky") || (instance_exists(obj_lava_water) && y > (obj_lava_water.y + 16) && global.theme == "forest" && global.night == 0))
    {
        vspeed = -3
        swimming = 1
    }
