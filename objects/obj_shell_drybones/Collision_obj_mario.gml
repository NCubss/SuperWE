if (kickme == 1 && inmune == 0 && (!instance_exists(obj_invincibility)) && other.groundpount == 0)
{
    if (held == 0)
    {
        if (other.bbox_bottom < ((bbox_top - vspeed) + 5) && other.vspeed > 0 && global.yoshi == 0 && other.state == 2 && other.holding == 0 && ((!keyboard_check(global.lanzar_agarrar)) || global.style == 0))
            event_user(1)
