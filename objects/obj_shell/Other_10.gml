...
{
    case spr_SMB_shell:
        imdead.sprite_index = spr_SMB_shell_greenkoopa_dead
        break
    case spr_SMB_shell_red:
        imdead.sprite_index = spr_SMB_shell_redkoopa_dead
        break
    ...
    case spr_SMB_spiny_dead:
        imdead.sprite_index = spr_SMB_shell_spiny_dead
        break
    case spr_SMB_shell_empty:
        imdead.sprite_index = spr_SMB_shell_buzzybeetle_empty_dead
        break
    case spr_SMB_shell_empty_night:
        imdead.sprite_index = spr_SMB_shell_buzzybeetle_empty_night_dead
        break
    case spr_SMB_shell_empty_spiny:
        imdead.sprite_index = spr_SMB_shell_spiny_empty_dead
        break
    case spr_SMB3_shell:
    ...
    case spr_NSMBU_shell:
        imdead.sprite_index = spr_NSMBU_shell_greenkoopa_dead
        break
    case spr_NSMBU_shell_red:
        imdead.sprite_index = spr_NSMBU_shell_redkoopa_dead
        break
    ...
    case spr_NSMBU_spiny_dead:
        imdead.sprite_index = spr_NSMBU_shell_spiny_dead
        break
    ...
    case spr_NSMBU_shell_buzzy_empty:
        imdead.sprite_index = spr_NSMBU_shell_buzzybeetle_empty_dead
        break
    case spr_NSMBU_shell_spiny_empty:
        imdead.sprite_index = spr_NSMBU_shell_spiny_empty_dead
        break
    default:
        imdead.sprite_index = spr_shell_deads
}
