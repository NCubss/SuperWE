if (kickme == 1 && inmune == 0 && (!instance_exists(obj_invincibility)))
{
    if (held == 0)
    {
        ...
        {
            other.holding = 2
            if (global.style == 2 && other.isduck == 1)
                isduckhold = 1
            if (global.style == 3)
            {
        ...
        else if (bbox_bottom < ((other.bbox_top - other.vspeed) + 5) && vspeed >= 0 && object_index == obj_shell_empty && (!instance_exists(obj_helmet)) && global.style != 3 && other.helmet == 0)
        {
        ...
        else if (bbox_bottom < ((other.bbox_top - other.vspeed) + 5) && vspeed >= 0 && object_index == obj_spiny_empty && (!instance_exists(obj_helmet)) && global.style != 3 && other.helmet == 0)
        {
        ...
        {
            if (global.style == 3 && other.bbox_bottom < ((bbox_top - vspeed) + 14) && other.groundpount == 2)
            {
            ...
            else if ((other.stompstyle == 1 || global.yoshi == 1) && other.bbox_bottom < ((bbox_top - vspeed) + 5) && other.vspeed > 0)
            {
                ...
                {
                    if (object_index == obj_spiny_empty && global.style > 1)
                    {
                        with (other.id)
                            event_user(1)
            ...
            else if (vspeed >= 0 || (vspeed >= 0 && global.yoshi > 0))
            {
                ...
                else
                {
                    ...
                    with (obj_mario)
                    {
                        if (holding == 0 && global.style != 0 && global.style != 3)
                            event_user(7)
                    }
                    alarm[5] = -1
