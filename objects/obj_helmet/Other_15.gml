...
if (global.style != 2 && (sprite_index == spr_SMB_helmet_small || sprite_index == spr_SMB_helmet_big || sprite_index == spr_SMB3_helmet_small || sprite_index == spr_SMB3_helmet_big))
{
