...
{
    case "ground":
        if (global.style == 3 && global.night == 0)
        {
...
if (room == rm_title)
{
    if ((global.theme != "mountain") && (global.night == 1))
...
else if ((global.theme == "forest" && global.night == 0) || global.theme == "beach")
{
    if instance_exists(obj_lava_water)
    {
        with (obj_lava_water)
...
else if !instance_exists(obj_lava_water) && ((global.theme == "mountain") && (global.night == 1))
{
    if instance_exists(obj_lava_water)
    {
        with (obj_lava_water)
...
else if instance_exists(obj_lava_water) && ((global.theme == "mountain") && (global.night == 0))
{
    with (obj_lava_water)
        instance_destroy()
}
