if (hunger == 0 && ready == 0 && other.object_index != obj_thwomp && other.object_index != obj_grinder && other.object_index != obj_banzaibill && other.object_index != obj_bowserjr_shell && other.object_index != obj_grrrol)
{
    ...
    else
    {
        ...
        if ((other.object_index == obj_cheepcheep || other.object_index == obj_cheepcheep2) && other.lava == 1 && global.theme == "castle")
            obj_yoshi2.mouthholder = obj_yoshifire
        else if ((other.object_index == obj_cheepcheep || other.object_index == obj_cheepcheep2) && other.lava == 1 && global.theme == "forest")
