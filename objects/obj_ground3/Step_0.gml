...
if (obj_levelmanager.editor == 1)
{
    ...
    if (mouse_check_button(mb_left) && obj_editormanager.expand_open == 0 && poder_girar == 1 && crecer_h == 0 && crecer_v == 0)
    {
        if (mouse_x > (x + 16) && can_up == 0 && room_width < 9216)
            crecer_h = 1
        else if (mouse_x < x && can_up == 0 && ((room_width > 384 && global.theme != "castle" && obj_editormanager.zoom == 0) || (room_width > 496 && global.theme == "castle" && obj_editormanager.zoom == 0) || (room_width > 768 && global.theme != "castle" && obj_editormanager.zoom != 0) || (room_width > 992 && global.theme == "castle" && obj_editormanager.zoom != 0)))
            crecer_h = 2
