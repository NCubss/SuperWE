...
if instance_exists(obj_mario)
{
    ...
    else if (obj_mario.state == 2 && global.powerup != -39 && global.style != 0)
    {
    ...
    else if (obj_mario.state == 1 && global.style != 0)
    {
        m_sprite = scr_mario_drybones_jump()
