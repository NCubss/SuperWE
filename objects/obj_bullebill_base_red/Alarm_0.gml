...
else if ((obj_mario.x - 2) <= x && obj_mario.x > (x - 256) && y >= (obj_mario.y - 160) && (!collision_rectangle((bbox_left - 1), y, (bbox_left - 1), (y + 15), obj_solid, 0, 0)) && (!collision_rectangle((bbox_left - 1), y, (bbox_left - 1), (y + 15), obj_physicssolid, 0, 0)) && (!collision_rectangle((bbox_left - 1), y, (bbox_left - 1), (y + 15), obj_solidphy, 0, 0)) && (!collision_rectangle((bbox_left - 1), y, (bbox_left - 1), (y + 15), obj_bullebill_base, 0, 0)) && (!collision_rectangle((bbox_left - 1), y, (bbox_left - 1), (y + 15), obj_mario, 0, 0)))
{
    ...
    else
    {
        ...
        {
            case 2:
                audio_play_sound(snd_explode_red, 0, false)
                break
            case 3:
                audio_play_sound(snd_NSMBU_bullet, 0, false)
                break
            default:
                audio_play_sound(snd_SMB3_explode_red, 0, false)
        }
