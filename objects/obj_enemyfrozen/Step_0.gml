...
if (held == 0)
{
    ...
    else if (instance_exists(obj_lava_water) && (bbox_bottom - 8) > (obj_lava_water.y - 12) && global.theme == "forest" && global.night == 1 && modo_lava == 0)
    {
        instance_create(x, (obj_lava_water.y - 26), obj_splash_posion)
        event_user(0)
    }
    else if (instance_exists(obj_lava_water) && (bbox_bottom - 8) > (obj_lava_water.y - 12) && global.theme == "mountain" && global.night == 1 && modo_lava == 0)
    {
        instance_create(x, (obj_lava_water.y - 26), obj_splash_lava)
        event_user(0)
    }
