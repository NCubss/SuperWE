if surface_exists(surf)
{
    ...
    if instance_exists(obj_mario)
    {
        ...
        {
            with (obj_mario)
                draw_circle((x - camera_x), ((y + 16) - camera_y), 216, 0)
            draw_set_colour(c_white)
            draw_set_alpha(1)
            with (obj_mario)
                draw_circle((x - camera_x), ((y + 16) - camera_y), 200, 0)
        }
        else
        {
            with (obj_mario)
                draw_circle((x - camera_x), ((y + 16) - camera_y), 62, 0)
            draw_set_colour(c_white)
            draw_set_alpha(1)
            with (obj_mario)
                draw_circle((x - camera_x), ((y + 16) - camera_y), 54, 0)
        }
    }
        ...
        with (obj_enemyparent)
        {
            if (visible == true)
            {
                if (object_index == obj_thwomp)
                    draw_circle((x - camera_x), (y - camera_y), 30, 0)
                else if (object_index == obj_banzaibill)
                    draw_circle((x - camera_x), (y - camera_y), 55, 0)
                else if (object_index == obj_jumppiranha)
                    draw_circle(((x + 8) - camera_x), (y - camera_y), 25, 0)
                else
                    draw_circle((x - camera_x), (y - camera_y), 25, 0)
            }
        }
    }
    ...
    {
        with (obj_key)
            draw_circle(((x + 8) - camera_x), (y - camera_y), 20, 0)
    }
    ...
    if instance_exists(obj_bullebill_base)
    {
        with (obj_bullebill_base)
            draw_circle(((x + 8) - camera_x), (y - camera_y), 35, 0)
    }
    if instance_exists(obj_wrench)
    {
        with (obj_wrench)
            draw_circle((x - camera_x), (y - camera_y), 20, 0)
    }
    ...
    {
        with (obj_ground2)
            draw_circle(((x + 24) - camera_x), ((y - 24) - camera_y), 35, 0)
    }
    ...
    if instance_exists(obj_soplete)
    {
        ...
        {
            if (invisible == 0)
                draw_circle((x - camera_x), ((y - 24) - camera_y), 45, 0)
        }
    }
    ...
    {
        with (obj_explosion)
            draw_circle(((x + 11) - camera_x), ((y + 11) - camera_y), 25, 0)
    }
    if instance_exists(obj_plantfire)
    {
        with (obj_plantfire)
            draw_circle((x - camera_x), (y - camera_y), 15, 0)
    }
    if instance_exists(obj_coin)
    {
        with (obj_coin)
            draw_circle(((x + 8) - camera_x), ((y + 8) - camera_y), 20, 0)
    }
    if instance_exists(obj_coin10)
    {
        with (obj_coin10)
            draw_circle(((x + 16) - camera_x), ((y + 16) - camera_y), 25, 0)
    }
    if instance_exists(obj_flagpole)
    {
        with (obj_flagpole)
            draw_circle(((x + 105) - camera_x), ((y + 80) - camera_y), 190, 0)
    }
    ...
    {
        with (obj_fireball)
            draw_circle((x - camera_x), (y - camera_y), 16, 0)
    }
