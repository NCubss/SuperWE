if (stomp != -1 && other.invincible != -1 && (!instance_exists(obj_slider)))
{
    ...
    if (global.style == 3 && other.bbox_bottom < ((bbox_top - vspeed) + 14) && (stomp == 0 || stomp == 3) && (other.groundpount == 2 || other.helice_fly == 4))
    {
    ...
    else if (other.bbox_bottom < ((bbox_top - v_speed) + altura))
    {
        if (stomp != 3 && stomp != 5 && stomp != 6 && (other.stompstyle == 1 || global.yoshi == 1 || global.yoshi == 2))
        {
            if (stomp == 0 || stomp == 4)
            {
                ...
                {
                    if (variable_instance_exists(id, "key") && key == 1)
                    {
            ...
            else if (stomp == 1 && object_index == obj_pokey && image_index == 0 && global.theme == "snow")
            {
        ...
        else if (stomp == 1 && object_index == obj_pokey && image_index == 0 && global.theme == "snow" && global.powerup != -80)
        {
            audio_play_sound(scr_snd_kick(), 0, false)
            with (other.id)
                event_user(1)
