if instance_exists(obj_mario)
{
    if (obj_mario.state == 1 && (!(collision_rectangle(bbox_left, (bbox_bottom + 1), bbox_right, (bbox_bottom + 1), obj_lava_water_drybones, 0, 0))))
    {
        ...
        {
            offsetnext = 0
            if (global.style == 3 && object_index == obj_kuribo_drybones && (!(collision_rectangle(bbox_left, (bbox_bottom + 8), bbox_right, (bbox_bottom + vspeed), obj_lava_water_drybones, 0, 0))))
            {
