...
if (vspeed > 0)
{
    ...
    if (y > (camera_get_view_y(view_get_camera(0)) + 248) || (vspeed > 0 && instance_exists(obj_lava_water) && y > (obj_lava_water.y + 32) && (global.theme == "castle" || (global.theme == "forest" && global.night == 1 || global.theme == "mountain" && global.night == 1))))
        instance_destroy()
}
if (modo_lava == 1)
    hspeed = 0
