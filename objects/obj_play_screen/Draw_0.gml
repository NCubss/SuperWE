if (object_index == obj_play_screen)
{
    ...
    draw_sprite_ext(sprite_index, global.language, (camera_get_view_x(view_get_camera(0)) + 197), (camera_get_view_y(view_get_camera(0)) + 130), image_xscale, image_yscale, rot1, c_white, 1)
	if (effect_hover == 1){
		anim += 0.3
...
else
{
    ...
    draw_sprite_ext(sprite_index, global.language, (camera_get_view_x(view_get_camera(0)) + 135), (camera_get_view_y(view_get_camera(0)) + 130), image_xscale, image_yscale, rot1, c_white, 1)
	if (effect_hover == 1){
		anim += 0.3
