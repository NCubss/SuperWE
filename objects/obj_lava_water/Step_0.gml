...
{
    if ((obj_levelmanager.editor == 1) && (((global.theme == "forest") && (global.night == 1)) || ((global.theme == "castle") || ((global.theme == "mountain") && (global.night == 1)))))
    {
        image_speed = 0
        image_index = 0
        image_alpha = 0.4
    ...
    else if (obj_levelmanager.editor == 1 && (global.theme == "forest" || global.theme == "beach"))
    {
        image_speed = 0
        image_index = 0
        image_alpha = 1
