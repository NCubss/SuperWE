if (held == 1)
{
    ...
    if instance_exists(obj_mario)
    {
        ...
        {
            if (keyboard_check(global.abajo) && obj_mario.state < 2 && obj_mario.stompstyle == 0 && global.style != 3 && obj_mario.helmet == 0 && (object_index == obj_spiny_empty || object_index == obj_shell_empty))
                obj_mario.holding = 0
            else
                obj_mario.holding = 2
            direct = 1
