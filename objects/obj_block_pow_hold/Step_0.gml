...
if (held == 0)
{
    ...
    else if (instance_exists(obj_lava_water) && (y + 8) >= obj_lava_water.y && global.theme == "forest" && global.night == 1 && modo_lava == 0)
    {
        if (global.style != 0)
            instance_create((x + 8), (obj_lava_water.y - 26), obj_splash_posion)
        modo_lava = 1
    }
    else if (instance_exists(obj_lava_water) && (y + 8) >= obj_lava_water.y && global.theme == "mountain" && global.night == 1 && modo_lava == 0)
    {
        if (global.style != 0)
            instance_create((x + 8), (obj_lava_water.y - 26), obj_splash_lava)
        modo_lava = 1
