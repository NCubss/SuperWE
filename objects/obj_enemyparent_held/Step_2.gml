if (held == 1)
{
    ...
    if instance_exists(obj_mario)
    {
        ...
        else
        {
            ...
            else if (keyboard_check(global.abajo) && obj_mario.state < 2 && obj_mario.helmet == 0 && global.style != 3 && object_index == obj_shell_empty)
            {
            ...
            else if (keyboard_check(global.abajo) && obj_mario.state < 2 && obj_mario.helmet == 0 && global.style != 3 && object_index == obj_spiny_empty)
            {
            ...
            else if (keyboard_check(global.abajo) && obj_mario.vspeed == 0 && global.style == 2)
                y = (obj_mario.y + 16)
        }
        ...
        {
            if (keyboard_check(global.abajo) && obj_mario.state < 2 && obj_mario.stompstyle == 0 && global.style != 3 && (object_index == obj_spiny_empty || object_index == obj_shell_empty))
                obj_mario.holding = 0
            else
                obj_mario.holding = 2
