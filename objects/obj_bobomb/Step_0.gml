...
if paracaidas == 1{
	...
	image_angle = 0
if (instance_exists(obj_lava_water) && (y + 16) >= obj_lava_water.y && global.theme == "castle")
{
    instance_create((x - 8), y, obj_explosion)
    instance_destroy()
}
else if (instance_exists(obj_lava_water) && (y + 16) >= obj_lava_water.y && global.theme == "mountain" && global.night == 1)
{
    instance_create((x - 8), y, obj_explosion)
    instance_destroy()
}