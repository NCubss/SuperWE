	...
	if (sprout == -1) {
		...
		with (shoot_left) {
			if (
				...
				|| object_index == obj_cheepcheep2
				|| object_index == obj_mushroom
				|| object_index == obj_1up
				|| object_index == obj_star
				|| object_index == obj_hen_mushroom
				|| object_index == obj_megamushroom
			) {
				alarm[10] = -1;
			}
			if (
