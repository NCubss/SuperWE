...
if ((!instance_exists(obj_mario)) || obj_mario.x < x)
    ...
    direct = 1
if (instance_exists(obj_lava_water) && (bbox_top - 2) > (obj_lava_water.y - 12) && global.theme == "castle")
{
    if (global.style != 0)
...
if (instance_exists(obj_lava_water) && (bbox_top - 2) > (obj_lava_water.y - 12) && global.theme == "forest" && global.night == 1)
{
    if (global.style != 0)
