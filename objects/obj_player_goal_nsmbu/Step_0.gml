...
if (global.theme == "underwater" || (instance_exists(obj_lava_water) && y > (obj_lava_water.y + 16)))
    swim = 1
else
    swim = 0
...
if (ready == 2 || ready == 3)
{
    ...
    if (global.theme == "underwater" || (global.night == 1 && global.theme == "sky") || (instance_exists(obj_lava_water) && y > (obj_lava_water.y + 16) && global.theme == "forest" && global.night == 0))
        swimming = 1
    else
        swimming = 0
    event_user(3)
