...
if (wings == 1)
{
    draw_sprite_ext(spr_wings_editor, global.style, (x_draw - 8), (y_draw - 20), -1, 1, 0, c_white, 1)
    draw_sprite_ext(spr_wings_editor, global.style, ((x_draw + (size_x * 16)) + 8), (y_draw - 20), 1, 1, 0, c_white, 1)
}
for (h = 0; h < size_x; h++)
{
    if (h == 0)
