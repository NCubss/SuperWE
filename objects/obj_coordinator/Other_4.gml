...
camera_set_view_size(view_camera[0],  global.gh, camera_height)
camera_set_view_size(view_camera[0],  global.gw, camera_width)
camera_set_view_border(view_camera[0], (global.gh / 2), camera_get_view_border_y(view_camera[0]))
camera_set_view_border(view_camera[0], (global.gw / 2), camera_get_view_border_x(view_camera[0]))
