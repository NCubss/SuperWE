...
if (vk_movimientos == 1) {
	if (global.sm4j_style == 1) {
		if keyboard_check(global.arriba) {
			draw_sprite_ext(
				spr_keyup_sm4j, 1,
				(camera_get_view_x(view_get_camera(0)) + 32),
				(camera_get_view_y(view_get_camera(0)) + 80),
				1, 1, 0, c_white, 0.2
			);
		} else {
			draw_sprite_ext(
		...
		if keyboard_check(global.abajo) {
			draw_sprite_ext(
				spr_keydown_sm4j, 1,
				(camera_get_view_x(view_get_camera(0)) + 32),
				(camera_get_view_y(view_get_camera(0)) + 178),
				1, 1, 0, c_white, 0.2
			);
		} else {
			draw_sprite_ext(
		...
		if keyboard_check(global.izquierda) {
			draw_sprite_ext(
				spr_keyleft_sm4j, 1,
				(camera_get_view_x(view_get_camera(0)) - 34),
				(camera_get_view_y(view_get_camera(0)) + 144),
				1, 1, 0, c_white, 0.2
			);
		} else {
			draw_sprite_ext(
