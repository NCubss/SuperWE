...
if (global.pp == 0)
{
    ...
    if pblock
    {
        ...
        canjump = 1
    if ((global.night == 1 && global.theme == "snow") || collision_rectangle(bbox_left, (bbox_bottom + 1), bbox_right, (bbox_bottom + 1), obj_block_ice, 0, 0) || collision_rectangle(bbox_left, (bbox_bottom + 1), bbox_right, (bbox_bottom + 1), obj_icecoin, 0, 0))
        snow = 1
    else
        snow = 0
    ...
    if (vspeed < 0 && (collision_rectangle(bbox_left, (bbox_top - 1), bbox_right, bbox_top, obj_solid, 1, 0) || collision_rectangle(bbox_left, (bbox_top - 1), bbox_right, bbox_top, obj_physicssolid, 1, 0) || collision_rectangle(bbox_left, (bbox_top - 1), bbox_right, bbox_top, obj_bullebill_base, 1, 0) || (pswitch && pswitch.held == 0 && (pswitch.y + 16) < bbox_top) || (one_2 && (bbox_top + 5) >= one_2.bbox_bottom)))
    {
        ...
        if (block_col && block_col.vspeed == 0 && block_col.object_index == obj_flipblock && global.style != 2 && ((global.powerup != 0 && global.powerup != -85) || ((global.powerup == 0 || global.powerup == -85) && instance_exists(obj_helmet))))
        {
            with (block_col)
                alarm[2] = 1
        }
    ...
    if (state < 3)
    {
        if (state != 2 && disablecontrols == 0)
        {
            ...
            else if (keyboard_check(global.abajo) && holding == 2 && noisy == 0 && global.style == 2)
            {
                isduck = 1
                isduckhold = 1
            }
			...
			else if (keyboard_check(global.abajo) && (((holding == 0) || (holding == 3)) && ((noisy == 0) && ((global.style == 2) || (global.powerup == -80)))))
                isduck = 1
            ...
            if (keyboard_check(global.arriba) && holding < 3 && noisy == 0 && global.style == 2)
            {
                isup = 1
                if (holding == 2)
                    isuphold = 1
        ...
        else if (state == 2 && disablecontrols == 0)
        {
            ...
            else if (isduck == 1 && holding == 2 && noisy == 0 && global.style == 2)
                isduckhold = 1
        }
        ...
        isduck = 0
    if (isswim == 0 && (global.theme == "underwater" || (global.theme == "castle" && global.night == 1) || (instance_exists(obj_lava_water) && (y + 18) >= obj_lava_water.y && ((global.theme == "forest" && global.night == 0) || global.theme == "beach"))))
    {
        dash_atack = 0
        dash_cont = 0
        down_atack = 0
        down_cont = 0
        if (holding == 2 && global.style == 2)
            isswimhold = 1
        isswim = 1
        if (instance_exists(obj_lava_water) && (bbox_bottom - 8) > (obj_lava_water.y - 12) && global.style != 0)
            instance_create(x, (obj_lava_water.y - 26), obj_splash_agua)
        if (state > 2)
            state = 2
    }
if (isswim == 0 && (global.theme == "underwater" || (global.theme == "castle" && global.night == 1) || (instance_exists(obj_lava_water) && global.theme == "forest" && global.night == 0 && (y + 18) >= obj_lava_water.y) || (instance_exists(obj_lava_water) && global.theme == "beach" && (y + 18) >= obj_lava_water.y)))
{
    if (holding == 2 && global.style == 2)
        isswimhold = 1
    isswim = 1
...
if (y < -96)
        y = -96
    else if (((bbox_top - 32) > room_height) && (global.theme != "castle"))
    {
    ...
    else if ((instance_exists(obj_lava_water) && (((global.theme == "castle") || ((global.theme == "forest") && (global.night == 1))) && (((y + 32) >= obj_lava_water.y) && (!instance_exists(obj_kuribo_drybones))))) || (instance_exists(obj_lava_water) && (((global.theme == "castle") || ((global.theme == "forest") && (global.night == 1))) && (((y + 32) >= (obj_lava_water.y + 12)) && instance_exists(obj_kuribo_drybones)))))
    {
        instance_create(x, y, obj_deadmario)
        instance_destroy()
    }
    else if ((instance_exists(obj_lava_water) && ((global.theme == "mountain") && (global.night == 1)) && (((y + 32) >= obj_lava_water.y) && (!instance_exists(obj_kuribo_drybones))) || (instance_exists(obj_lava_water) && ((global.theme == "mountain") && (global.night == 1)) && (((y + 32) >= (obj_lava_water.y + 12)) && instance_exists(obj_kuribo_drybones)))))
    {
        instance_create(x, y, obj_deadmario)
        instance_destroy()
    }
  if (((global.theme == "underwater") && (isswim == 0)) || (((global.theme == "castle") && ((global.night == 1) && (isswim == 0))) || (instance_exists(obj_lava_water) && ((global.theme == "forest") && ((global.night == 0) && (((y + 18) >= obj_lava_water.y) && (isswim == 0)))))))
    {
        if ((holding == 2) && (global.style == 2))
            isswimhold = 1
        isswim = 1
