...
if (keyboard_check_pressed(global.saltar) && disablecontrols == 0 && jumpnow == 0 && state < 2 && (sprite_index != spr_SMB_link_shield || global.yoshi > 0))
{
    if (abs(hspeed) > 2.8)
    {
        if (global.theme == "sky" && global.night == 1)
        {
    ...
    else if (global.theme == "sky" && global.night == 1)
    {
        if (global.powerup == -78)
        {
            if (round((hspeed / 2)) == 0)
...
if ((keyboard_check_pressed(global.saltar_spin) && global.style == 2 && disablecontrols == 0 && holding == 0 && isduck == 0 && jumpnow == 0 && state < 2) || (keyboard_check_pressed(global.saltar_spin) && (global.style == 2 || global.style == 3) && disablecontrols == 0 && holding == 3 && isduck == 0 && global.yoshi > 0 && vspeed == 0 && jumpnow == 0 && state < 2))
{
    image_index = 0
    if (abs(hspeed) > 2.8)
    {
...
else if ((keyboard_check_pressed(global.saltar_spin) && disablecontrols == 0 && holding == 2 && jumpnow == 0 && state < 2) || (keyboard_check_pressed(global.saltar_spin) && disablecontrols == 0 && holding == 3 && global.yoshi > 0 && vspeed != 0 && global.style == 2 && state == 2) || (keyboard_check_pressed(global.saltar_spin) && disablecontrols == 0 && holding == 3 && global.yoshi > 0 && global.style != 2) || (keyboard_check_pressed(global.saltar_spin) && disablecontrols == 0 && jumpnow == 0 && state < 2 && global.style != 2 && global.powerup != -85))
{
    if (abs(hspeed) > 2.8)
    {
        if (global.theme == "sky" && global.night == 1)
...
else
{
    ...
    {
        if (holding == 2 && direct != 1 && stompstyle == 0 && global.style == 2)
        {
            turning = 1
            alarm[11] = 7
        }
        ...
        if (modo_vuelo == 0 && arrow == 0 && (global.style != 0 || inclown == 2 || (global.style == 0 && state != 2) || (global.powerup == -80)))
            direct = 1
        direct_turn = 1
    }
    else if (keyboard_check(global.izquierda) && (!keyboard_check(global.derecha)) && disablecontrols == 0 && modo_vuelo == 0 && dash_atack == 0)
    {
        ...
        if (modo_vuelo == 0 && arrow == 0 && direct_turn != 1 && (global.style != 0 || inclown == 2 || (global.style == 0 && state != 2) || (global.powerup == -80)))
            direct = -1
        direct_turn = -1
    }
    else if (state != 2)
...
{
    if (global.night == 1 && global.theme == "sky")
    {
...
/*
if (keyboard_check_pressed(global.abajo) && disablecontrols == 0 && holding == 0 && global.style != 0)
{
...
if (global.style == 0 && global.powerup != -85 && holding != 0)
    holding = 0
