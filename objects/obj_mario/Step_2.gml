...
if (global.pp == 0) {
	...
	if (frog_jump != 0 && state != ms_walking) frog_jump = 0;
	if (global.powerup == -29 && isswim == 1) isduck = 0;
	if (link_transform == 1) {
	...
	if (isduck == 0) {
		...
		if (holding == 0) {
			...
			if (
				...
				&& global.powerup != -29
				&& (
					(direct == 1 && hspeed < 0 && keyboard_check(global.derecha))
					|| (direct == -1 && hspeed > 0 && keyboard_check(global.izquierda))
				)
			) {
				...
				if (caped > 0) {
					...
					if (global.powerup != -29 && skidnow == 1) {
						sprite_index = scr_marioskid();
				...
				if (caped > 0) {
					...
					if (skidnow == 1) {
						...
						if (pmeter < 6) {
							sprite_index = scr_mariowalk()
						} else if (global.style == GameStyle.SMB) {
							sprite_index = scr_mariowalk();
						} else {
					...
					image_speed = spd_i;
					if (pmeter < 6 || global.style == GameStyle.SMB) {
						sprite_index = scr_mariowalk();
					} else {
						sprite_index = scr_mariorun();
					}
				}
			} else if (state == ms_jumping) {
				if (isswim == 1) {
					if (caped > 0) {
						if instance_exists(obj_mario_transform2) {
							image_speed = 0;
					...
					else if (noisy == 0)
					{
						...
						{
							if ((global.powerup == -85 && image_index >= 2.85) || (global.style == 0 && image_index >= 4.75) || (global.style != 0 && image_index >= 2.85))
							{
								sprite_index = scr_marioswimhold()
								image_index = 0
							}
							else if (global.style == 0 && global.powerup != -85)
								image_speed = 0.25
							else
								image_speed = 0.15
						}
				...
				{
					if (global.style == 1 && global.powerup != -29 && global.powerup != 0 && instance_exists(obj_invincibility))
					{
					...
					else
					{
						...
						if (global.powerup != -39)
						{
							if (vspeed > 0 || collision_rectangle(bbox_left, (bbox_top + 4), bbox_right, (bbox_bottom - 1), obj_bortice, 0, 0))
							{
								...
								else if (global.style == 0 && jumpnow == 0)
								{
									sprite_index = scr_mariowalk()
									image_index = 0
								}
				...
				else if (global.style == 1 && global.powerup != 0 && global.powerup != -39 && global.powerup != -29 && instance_exists(obj_invincibility))
				{
					sprite_index = scr_mariojumpstar()
					image_speed = 0.4
				}
		...
		else
		{
			...
			if (state == 2)
			{
				if (turning == 0)
				{
					...
					else
					{
						...
						{
							if (global.powerup != 0 && global.style == 1)
								image_index = 2
							else
								image_index = 1
						}
			...
			{
				if (global.style == 1 && global.powerup == -39 && vspeed != 0)
		...
		{
			sprite_index = scr_marioskid()
			if (skidnow == 0 && global.style != 0)
			{
				skidnow = 1
				audio_play_sound(scr_snd_skid(), 1, true)
			}
		}
		if (iamkicking == 1 && stompstyle == 0 && (global.style != 0 || global.powerup == -85 || global.powerup == -80))
		{
			if (global.powerup == -29 && isswim == 1)
			{
			}
	...
	else if (isduck == 1)
	{
		...
		{
			if (keyboard_check(global.derecha) && (!keyboard_check(global.izquierda)) && disablecontrols == 0 && (global.style != 0 || (global.style == 0 && vspeed == 0) || (global.powerup == -80)))
				direct = 1
			else if (keyboard_check(global.izquierda) && (!keyboard_check(global.derecha)) && disablecontrols == 0 && (global.style != 0 || (global.style == 0 && vspeed == 0) || (global.powerup == -80)))
				direct = -1
		}
		if (global.powerup == -39)
		{
