...
if (gp_limit > 0)
    gp_limit--
if (keyboard_check_pressed(global.abajo) && (helice_fly == 0 || helice_fly == 5) && global.style == 3 && disablecontrols == 0 && (!(place_meeting(x, y, obj_bortice))) && state == 2 && isduck == 0 && holding == 0 && iamkicking == 0 && global.yoshi == 0 && inclown == 0 && airspin != 1 && groundpount == 0 && gp_limit == 0 && walljump == 0 && stompstyle == 0 && doublejump == 0)
{
    image_index = 0
    groundpount = 1
    airspin = 0
...
if (keyboard_check_pressed(global.arriba) && global.style == 3 && disablecontrols == 2 && state == 2 && groundpount != 0 && stompstyle == 0)
{
    if (groundpount == 1)
...
if (keyboard_check_pressed(global.saltar_spin) && global.style == 3 && disablecontrols == 0 && state == 2 && global.yoshi == 0 && airspin == 0 && walljump != 1 && inclown == 0 && groundpount != 1 && stompstyle == 0 && (global.powerup != -43 || doublejump == 2 || holding == 2) && (global.powerup != -30 || helice_fly == 5))
{
    if (triple_jump == 0)
        image_index = 0
    airspin = 1
