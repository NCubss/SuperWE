...
if pblock
{
    ...
    canjump = 1
if ((global.night == 1 && global.theme == "snow") || ((collision_rectangle(bbox_left, (bbox_bottom + 1), bbox_right, (bbox_bottom + 1), obj_block_ice, 0, 0) || collision_rectangle(bbox_left, (bbox_bottom + 1), bbox_right, (bbox_bottom + 1), obj_icecoin, 0, 0)) && global.powerup != -38))
    snow = 1
else
    snow = 0
...
|| (one_2 && (bbox_top + 5) >= one_2.bbox_bottom))) {
    ...
    if (block_col && block_col.vspeed == 0 && block_col.object_index == obj_flipblock && global.style != 2 && (global.powerup != 0 || (global.powerup == 0 && instance_exists(obj_helmet))))
    {
        with (block_col)
            alarm[2] = 1
    }
