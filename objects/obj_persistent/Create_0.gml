...
global.ctor = string("{0} | {1}", date_get_year(GM_build_date), global.game.name);
global.ver = global.game.version;
global.descver = string("{0} | {1} | Built {2}", global.game.name, global.game.version, date_date_string(GM_build_date));
