...
switch direct_t
{
    case 0:
        if (plant == 1)
            draw_sprite_ext(spr_pplant_res, global.style, (x_draw + 8), (y_draw - 8), 1, 1, rotacion, c_white, m_alpha)
    ...
    case 1:
        if (plant == 1)
            draw_sprite_ext(spr_pplant_res, global.style, (x_draw + (40 + (size * 16))), (y_draw + 8), 1, 1, rotacion, c_white, m_alpha)
    ...
    case 2:
        if (plant == 1)
            draw_sprite_ext(spr_pplant_res, global.style, (x_draw + 24), (y_draw + (40 + (size * 16))), 1, 1, rotacion, c_white, m_alpha)
    ...
    case 3:
        if (plant == 1)
            draw_sprite_ext(spr_pplant_res, global.style, (x_draw - 8), (y_draw + 24), 1, 1, rotacion, c_white, m_alpha)
        draw_sprite_ext(sprite, image_index, (x_draw + 16), (y_draw + 16), s_scalex, s_scaley, rotacion, c_white, m_alpha)
        xx = (x_draw + 16)
        yy = (y_draw + 16)
        break
