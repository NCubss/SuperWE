...
if (bbox_top > (room_height + 46) || (instance_exists(obj_lava_water) && y > (obj_lava_water.y + 32) && (global.theme == "castle" || (global.theme == "forest" && global.night == 1) || (global.theme == "mountain" && global.night == 1))))
    instance_destroy()
event_user(14)
