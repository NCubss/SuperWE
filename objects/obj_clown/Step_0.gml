if (inmario == 1)
{
    ...
    if instance_exists(obj_mario)
    {
        ...
        if (keyboard_check_pressed(global.saltar) || (keyboard_check_pressed(global.saltar_spin) && global.style != 2))
        {
            inmario = 2
            hspeed = 0
            alarm[1] = 40
            with (obj_mario)
            {
                if (global.theme == "underwater" || (global.night == 1 && global.theme == "sky") || (instance_exists(obj_lava_water) && (y + 16) > obj_lava_water.y && global.theme == "forest" && global.night == 0))
                    vspeed = -2
                else
                    vspeed = -3.75
        ...
        else if (keyboard_check_pressed(global.saltar_spin) && (global.style == 2 || global.style == 3))
        {
            inmario = 2
            hspeed = 0
            alarm[1] = 40
