...
global.languages = {
	es: {
		disclaimer: {
			title: "¡ADVERTENCIA!",
			text: "Este es un 'Fan Game' (de fans para fans)#por lo cual no está respaldado por Nintendo.#Todas las imágenes, músicas y recursos utilizados#en este son propiedad de Nintendo."
		},
		calendar: {
			monday: "Lunes",
			tuesday: "Martes",
			...
			friday: "Viernes",
			satuday: "Sábado",
			sunday: "Ya es domingo, ¡a hacer niveles se ha dicho!",
			christmas: "Feliz Navidad <3",
	...
	en: {
		...
		buttons: {
			...
			//quit: "Quit", // 151, unused
			report: "Report", // 153
			erase: "Erase", // 156
			//copy: "Copy", // 158, unused
		...
		messages: {
			...
			negative: {
				start_obstructed: "You have an object that obstructs the start",
				no_changes: "There are no items to save",
				course_exists: "This course already exists",
				load_failed: "Unable to load course", // 96
				read_failed: "Unable to read course", // 103
				outdated: "Can't connect / Update SMM:WE",
